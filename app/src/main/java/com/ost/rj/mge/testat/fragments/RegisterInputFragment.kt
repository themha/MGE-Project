...
class RegisterInputFragment (
    ...
    companion object {
        fun create(onInputChanged: (email : String, password : String, inputsAreValid : Boolean) -> Unit) : RegisterInputFragment {
            return RegisterInputFragment(onInputChanged)
        }
    }
    ...
    override fun onCreateView(
        ...
        var fragment : View = inflater.inflate(R.layout.fragment_register_input, container, false)
        ...
        editTextPassword.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                if (!isValidPassword) {
                    editTextPassword.error = "Password is invalid!"
                } else {
